...
def attack_main(model_name=None):
    ...
    attacked_models_list = [
        ...
        attacked_models.model_selection("vgg19").eval(),  # 模型2
        ...
        with th.enable_grad():
            ...
            if prev_grad is None:
               ...
               momentum_grad = grad
                ...
                # 计算动量梯度
                momentum_grad = momentum_factor * prev_grad + (1-momentum_factor)*final_grad
...
def create_attack_argparser():
    defaults = dict(
        ...
        model_name_list=["resnet50", "vgg19", "mobile_v2"]
        # model_name="resnet50",
        # model_name="convnext",
        # model_name="swin",
